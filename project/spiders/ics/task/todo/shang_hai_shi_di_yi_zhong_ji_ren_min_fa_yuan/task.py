...
from ics.crawler.ktgg.spiders.province.sh.shang_hai_shi_di_yi_zhong_ji_ren_min_fa_yuan import\
    ShangHaiShiDiYiZhongJiRenMingFaYuan

logger = get_ics_logger('shang_hai_shi_di_yi_zhong_ji_ren_min_fa_yuan')
...
def start(self, seed_dict):
    spider = ShangHaiShiDiYiZhongJiRenMingFaYuan(logger, seed_dict)
    spider.start()
