...
from ics.crawler.ktgg.spiders.province.sh.shang_hai_shi_gao_ji_ren_min_fa_yuan_wang import\
    ShangHaiShiGaoJiRenMinFaYuanWang

logger = get_ics_logger('shang_hai_shi_gao_ji_ren_min_fa_yuan_wang')
...
def start(self, seed_dict):
    spider = ShangHaiShiGaoJiRenMinFaYuanWang(logger, seed_dict)
    spider.start()
