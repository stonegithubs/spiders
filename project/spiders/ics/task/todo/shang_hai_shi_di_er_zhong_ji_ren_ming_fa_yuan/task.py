...
from ics.crawler.ktgg.spiders.province.sh.shang_hai_shi_di_er_zhong_ji_ren_ming_fa_yuan import\
    ShangHaiShiDiErZhongJiRenMingFaYuan

logger = get_ics_logger('shang_hai_shi_di_er_zhong_ji_ren_ming_fa_yuan')
...
def start(self, seed_dict):
    spider = ShangHaiShiDiErZhongJiRenMingFaYuan(logger, seed_dict)
    spider.start()
