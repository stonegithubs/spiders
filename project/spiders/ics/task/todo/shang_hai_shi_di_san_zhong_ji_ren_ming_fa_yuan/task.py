...
from ics.crawler.ktgg.spiders.province.sh.shang_hai_shi_di_san_zhong_ji_ren_ming_fa_yuan import\
    ShangHaiShiDiSanZhongJiRenMingFaYuan

logger = get_ics_logger('shang_hai_shi_di_san_zhong_ji_ren_ming_fa_yuan')
...
def start(self, seed_dict):
    spider = ShangHaiShiDiSanZhongJiRenMingFaYuan(logger, seed_dict)
    spider.start()
