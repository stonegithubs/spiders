...
from ics.crawler.ktgg.spiders.province.sh.shang_hai_shi_qing_pu_qu_ren_min_fa_yuan import\
    ShangHaiShiQingPuQuRenMinFaYuan

logger = get_ics_logger('shang_hai_shi_qing_pu_qu_ren_min_fa_yuan')
...
def start(self, seed_dict):
    spider = ShangHaiShiQingPuQuRenMinFaYuan(logger, seed_dict)
    spider.start()
