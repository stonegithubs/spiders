...
class SsfwBase(KtggIterPageBase):
    """
    肇庆市法院, 对应ktgg项目 1531.py 爬虫附近爬虫
    """
    domain = None
    ename = None
    cname = None
    ...
    def __init__(self, logger, seed_dict):
        ...
        super(SsfwBase, self).__init__(self.seed_dict, self.logger)
    ...
    def parse_per_page(self, html, page_url):
        ...
        for index, tr in enumerate(tr_list):
            ...
            try:
                ...
                self.ktgg_tool.insert_ktgg_data(data_dict, self.stat_dict, '{}_{}'.format(self.ename, doc_id))
            except Exception:
