...
60.166.151.111:4241"""
    ...
    def run(self, start_station, end_station):
        url = 'https://train.qunar.com/dict/open/s2s.do?callback=jQuery172012216425254778174_' + self._m + '&dptStation=' + start_station + '&arrStation=' + end_station + '&date=2019-08-20&type=normal&user=neibu&source=site&start=1&num=500&sort=3&_=' + self._m
        time.sleep(0.5)
